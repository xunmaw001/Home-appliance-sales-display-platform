...
//            jiadianCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<JiadianCommentbackEntity> jiadianCommentbackList = new ArrayList<>();//上传的东西
...
//                            jiadianCommentbackEntity.setJiadianId(Integer.valueOf(data.get(0)));   //商品 要改的
//                            jiadianCommentbackEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            jiadianCommentbackEntity.setJiadianCommentbackText(data.get(0));                    //评价内容 要改的
//                            jiadianCommentbackEntity.setInsertTime(date);//时间
//                            jiadianCommentbackEntity.setReplyText(data.get(0));                    //回复内容 要改的
//                            jiadianCommentbackEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
//                            jiadianCommentbackEntity.setCreateTime(date);//时间
                            jiadianCommentbackList.add(jiadianCommentbackEntity);
                        ...
                        //查询是否重复
                        jiadianCommentbackService.insertBatch(jiadianCommentbackList);
                        return R.ok();
                    }
                }
            }
