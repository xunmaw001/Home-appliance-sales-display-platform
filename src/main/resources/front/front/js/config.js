...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../jiadianCollection/list.html'
    }
    ,{
        name: '商品评价',
        url: '../jiadianCommentback/list.html'
    }
    ,{
        name: '商品订单',
        url: '../jiadianOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/jiadianxiaoshoupingtai/admin/dist/index.html#/login";
